...
int main(int argc, char *argv[])
{
    ...
    attilaLowLevelAPI.loadFragmentProgram(0x00002000, 0x100, fpCodeSize, fpCode, 1, nextBufferID++);
    ...
    attilaLowLevelAPI.writeGPURegister(GPU_BACKBUFFER_ADDR, 0, 0x00400000U);
    ...
    attilaLowLevelAPI.writeGPURegister(GPU_FRONTBUFFER_ADDR, 0, 0x00800000U);
    ...
    attilaLowLevelAPI.loadFragmentProgram(0x0000A000, 0x100, fpCodeSize, fpCode, 1, nextBufferID++);
    ...
    attilaLowLevelAPI.setTexture(0, GPU_TEXTURE2D,  0x00400000, 100, 100, 7, 7, GPU_RGBA8888, GPU_TXBLOCK_FRAMEBUFFER,
    ...
    attilaLowLevelAPI.resetColorState();
