#ifndef CSEMANTICMAPPING_9_H_INCLUDED
#define CSEMANTICMAPPING_9_H_INCLUDED
...
*/
class CSemanticMapping9 : public StateDataNodeController,
...
public:
    ...
    void on_write_node_data(StateDataNode* node, size_t size, UINT offset);
