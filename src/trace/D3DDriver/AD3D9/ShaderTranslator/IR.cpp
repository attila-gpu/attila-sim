...
D3DSHADER_PARAM_REGISTER_TYPE ParameterIRNode::getRegisterType()
{
    ...
    if ( static_cast<D3DSHADER_PARAM_REGISTER_TYPE>(((d3dToken.parameter.regTypeHi << 3) | (d3dToken.parameter.regTypeLo))) > D3DSPR_PREDICATE)
...
{
    if ( static_cast<D3DSHADER_PARAM_SRCMOD_TYPE>(d3dToken.dword & D3DSP_SRCMOD_MASK) > D3DSPSM_NOT)
        return D3DSPSM_NONE;
