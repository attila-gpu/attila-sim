...
IDirect3DQuery9InterceptorStub::IDirect3DQuery9InterceptorStub(DXPainter* painter, IDirect3DQuery9* original, IDirect3DDevice9InterceptorStub* creator) : 
...
IDirect3DQuery9InterceptorStub::~IDirect3DQuery9InterceptorStub()
{
  FREE_D3D_RESOURCE();
}
