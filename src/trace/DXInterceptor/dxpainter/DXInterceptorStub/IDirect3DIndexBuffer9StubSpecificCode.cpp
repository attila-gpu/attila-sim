...
IDirect3DIndexBuffer9InterceptorStub::IDirect3DIndexBuffer9InterceptorStub(DXPainter* painter, IDirect3DIndexBuffer9* original, IDirect3DDevice9InterceptorStub* creator) : 
...
IDirect3DIndexBuffer9InterceptorStub::~IDirect3DIndexBuffer9InterceptorStub()
{
  FREE_D3D_RESOURCE();
}
...
HRESULT IDirect3DIndexBuffer9InterceptorStub::DoSpecific(DXMethodCallPtr call)
{
  switch (call->GetToken())
  {
  case DXMethodCallHelper::TOK_IDirect3DIndexBuffer9_QueryInterface:
    {
      IID param1;
  ...
  case DXMethodCallHelper::TOK_IDirect3DIndexBuffer9_AddRef:
    {
  ...
  case DXMethodCallHelper::TOK_IDirect3DIndexBuffer9_Release:
    {
  ...
  case DXMethodCallHelper::TOK_IDirect3DIndexBuffer9_GetDevice:
    {
  ...
  case DXMethodCallHelper::TOK_IDirect3DIndexBuffer9_Lock:
    {
      UINT param1;
  ...
  case DXMethodCallHelper::TOK_IDirect3DIndexBuffer9_Unlock:
    {
  ...
  case DXMethodCallHelper::TOK_IDirect3DIndexBuffer9_GetPrivateData:
    return D3DResource9_GetPrivateData(m_original, call);
    break;

  case DXMethodCallHelper::TOK_IDirect3DIndexBuffer9_SetPrivateData:
    return D3DResource9_SetPrivateData(m_original, call);
    break;

  case DXMethodCallHelper::TOK_IDirect3DIndexBuffer9_FreePrivateData:
