...
BEGIN_MESSAGE_MAP(CTreeListColumnDragWnd, CWnd)
  //{{AFX_MSG_MAP(CTreeListColumnDragWnd)
  ON_WM_ERASEBKGND()
  ON_WM_PAINT()
  //}}AFX_MSG_MAP
END_MESSAGE_MAP()
...
/////////////////////////////////////////////////////////////////////////////
// CTreeListColumnDragWnd message handlers
BOOL CTreeListColumnDragWnd::Create( CRect rcWindow, CTreeListCtrl* pTreeListCtrl )
{
  // create window
...
BOOL CTreeListColumnDragWnd::OnEraseBkgnd(CDC* pDC) 
{
  // erase background
  return TRUE;
}

void CTreeListColumnDragWnd::OnPaintBMP()
{
...
void CTreeListColumnDragWnd::OnPaint() 
{
  CPaintDC dc(this);
...
BOOL CTreeListColumnDragWnd::DrawWnd( CDC* pDC )
{
  // draw window
  CRect rcItems;
  CRect rcClient;
...
void CTreeListColumnDragWnd::DrawItem( CDC* pDC, CRect rcItem, CTreeListItem* pItem )
{
...
void CTreeListColumnDragWnd::DrawItemBkgnd( CDC* pDC, CRect rcItem, CTreeListItem* pItem )
{
...
void CTreeListColumnDragWnd::DrawItemExclude( CDC* pDC, CRect rcItem, CTreeListItem* pItem )
{
...
void CTreeListColumnDragWnd::DrawItemTree( CDC* pDC, CRect rcColumn, CTreeListItem* pItem, int iCol )
{
...
void CTreeListColumnDragWnd::DrawItemMain( CDC* pDC, CRect rcColumn, CTreeListItem* pItem, int iCol )
{
...
void CTreeListColumnDragWnd::DrawItemList( CDC* pDC, CRect rcColumn, CTreeListItem* pItem, int iCol )
{
  // draw list
  CTreeListColumnInfo* pColumnInfo;
  pColumnInfo = (CTreeListColumnInfo*)m_pTreeListCtrl->m_arColumns[iCol];
...
void CTreeListColumnDragWnd::DrawItemTreeText( CDC* pDC, CRect rcBkgnd, CTreeListItem* pItem, int iCol )
{
  // draw text on tree
  CRect rcText;
  rcText = rcBkgnd;
...
void CTreeListColumnDragWnd::DrawItemText( CDC* pDC, CRect rcBkgnd, CRect rcText, CTreeListItem* pItem, int iCol )
{
  // draw item text
  COLORREF crBkgnd;
...
BOOL CTreeListColumnDragWnd::Show()
{
...
BOOL CTreeListColumnDragWnd::Hide()
{
