...
#ifndef ACDX_GENERICINSTRUCTION_H
    #define ACDX_GENERICINSTRUCTION_H
...
public:
    ...
    enum Opcode 
    {
        ...
        G_FRC, G_LG2, G_LIT, G_LOG, G_MAD, G_FXMAD, G_FXMAD2, G_MAX, G_MIN, 
        G_MOV, G_MUL, G_FXMUL, G_POW, G_RCP, G_RSQ, G_SGE, G_SLT, G_SUB, 
        G_SWZ, G_XPD, G_CMP, G_CMPKIL, G_CHS, G_COS, G_KIL, G_KLS, G_ZXP, G_ZXS, 
        G_LRP, G_SCS, G_SIN, G_TEX, G_TXB, G_TXP, G_ABS_SAT, G_ADD_SAT, G_CMP_SAT, 
        G_COS_SAT, G_DP3_SAT, G_DP4_SAT, G_DPH_SAT, G_DST_SAT, G_EX2_SAT, 
        G_FLR_SAT, G_FRC_SAT, G_LG2_SAT, G_LIT_SAT, G_LRP_SAT, G_MAD_SAT, 
        G_MAX_SAT, G_MIN_SAT, G_MOV_SAT, G_MUL_SAT, G_POW_SAT, G_RCP_SAT, 
        G_RSQ_SAT, G_SCS_SAT, G_SGE_SAT, G_SIN_SAT, G_SLT_SAT, G_SUB_SAT, 
        G_SWZ_SAT, G_TEX_SAT, G_TXB_SAT, G_TXP_SAT, G_XPD_SAT, INVALID_OP
    };
...
private:               
    ...
    void writeSample(unsigned int sample, std::ostream& os) const;

public:

    ACDXGenericInstruction(unsigned int line, 
                       ...
                       unsigned int killSample = 0,
                       unsigned int exportSample = 0,
...
#endif // ACDX_GENERICINSTRUCTION_H
