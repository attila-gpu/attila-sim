...
// 28-Apr-04 1.1
//
//   * Prevent most unsafe uses of evil static function hack.
...
// 27-Jun-04 1.2
//
//   * Now works on Borland C++ Builder 5.5
...
// 16-Jul-04 1.2.1
//
//   * Workaround for gcc bug (const member function pointers in templates)
//
// 30-Oct-04 1.3
//
//   * Support for (non-void) return values.
...
// 24-Dec-04 1.4
//
//   * Added DelegateMemento, to allow collections of disparate delegates.
...
// 14-Feb-05 1.4.1
//
//   * Now treats =0 as equivalent to .clear(), ==0 as equivalent to .empty(). (Thanks elfric).
//   * Now tested on Intel ICL for AMD64, VS2005 Beta for AMD64 and Itanium.
//
// 30-Mar-05 1.5
//
//   * Safebool idiom: "if (dg)" is now equivalent to "if (!dg.empty())"
...
// get if the compiler had native support for delegates.
