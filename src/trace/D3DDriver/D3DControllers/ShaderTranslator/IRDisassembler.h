/**
 * Disassembler visitor for IRNodes
 */

#ifndef __IR_DISASSEMBLER
#define __IR_DISASSEMBLER
 ...
 **/
class IRDisassembler : public IRVisitor {
public:
    void begin();
    void visit(IRNode *n);
    ...
    void end() { out->flush(); }
    IRDisassembler(std::ostream *o = &std::cout);
...
private:
    ...
    bool relAddressNodeVisited;
    bool preAppendComma;
    string relAddressStr;
};
