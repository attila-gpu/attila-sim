...
template< bool f > struct atl_static_assert;
template<>         struct atl_static_assert<true> { atl_static_assert() {} };
...
public:
    ...
    ~hetero_stack() // throw()
    {
        ...
        detail::atl_static_assert< detail::is_power_of_two<AlignmentT>::value > const align_test;
    ...
    inline void push( T const & t ) // throw(std::bad_alloc,...)
    {
        ...
        detail::atl_static_assert<( AlignmentT >= detail::atl_alignof<T>::value )> const align_test;
    ...
    {
        detail::atl_static_assert< RuntimeTypeCheckT > const type_check;
