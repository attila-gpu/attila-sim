...
IDirect3DVertexShader9InterceptorStub::IDirect3DVertexShader9InterceptorStub(DXPainter* painter, IDirect3DVertexShader9* original, IDirect3DDevice9InterceptorStub* creator) : 
...
IDirect3DVertexShader9InterceptorStub::~IDirect3DVertexShader9InterceptorStub()
{
  FREE_D3D_RESOURCE();
}
...
HRESULT IDirect3DVertexShader9InterceptorStub::DoSpecific(DXMethodCallPtr call)
{
  switch (call->GetToken())
  {
  case DXMethodCallHelper::TOK_IDirect3DVertexShader9_QueryInterface:
    {
      IID param1;
  ...
  case DXMethodCallHelper::TOK_IDirect3DVertexShader9_AddRef:
    {
  ...
  case DXMethodCallHelper::TOK_IDirect3DVertexShader9_Release:
    {
  ...
  case DXMethodCallHelper::TOK_IDirect3DVertexShader9_GetDevice:
    {
