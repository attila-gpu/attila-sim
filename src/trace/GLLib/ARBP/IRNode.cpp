...
IRNode::IRNode(unsigned int line)
: line(line)
{
}
...
: IRNode(line), optionString(optionString)
{
}
...
:   IRStatement(line), opCode(opcode), source0(0), source1(0), source2(0), dest(0)
{
...
void IRProgram::traverse(IRTraverser* it)
{
    bool visit = true;
...
void VP1IROption::traverse(IRTraverser* it)
{
    it->visitVP1Option(true,this,it);
}

void FP1IROption::traverse(IRTraverser *it)
{
    it->visitFP1Option(true,this,it);
}

void IRInstruction::traverse(IRTraverser *it)
{
    bool visit = true;
...
void IRSampleInstruction::traverse(IRTraverser *it)
{
    bool visit = true;
...
void IRSwizzleComponents::traverse(IRTraverser *it)
{
    it->visitSwizzleComponents(true,this,it);
}

void IRSwizzleInstruction::traverse(IRTraverser *it)
{
    bool visit = true;
...
void IRDstOperand::traverse(IRTraverser* it)
{
    it->visitDstOperand(true,this,it);
}

void IRArrayAddressing::traverse(IRTraverser* it)
{
    it->visitArrayAddressing(true,this,it);
}

void IRSrcOperand::traverse(IRTraverser* it)
{
    bool visit = true;
...
void IRALIASStatement::traverse(IRTraverser* it)
{
    it->visitALIASStatement(true,this,it);
}

void IRTEMPStatement::traverse(IRTraverser* it)
{
    it->visitTEMPStatement(true,this,it);
}

void IRADDRESSStatement::traverse(IRTraverser* it)
{
    it->visitADDRESSStatement(true,this,it);
}

void VP1IRATTRIBStatement::traverse(IRTraverser* it)
{
    it->visitVP1ATTRIBStatement(true,this,it);
}

void FP1IRATTRIBStatement::traverse(IRTraverser* it)
{
    it->visitFP1ATTRIBStatement(true,this,it);
}

void VP1IROUTPUTStatement::traverse(IRTraverser* it)
{
    it->visitVP1OUTPUTStatement(true,this,it);
}

void FP1IROUTPUTStatement::traverse(IRTraverser* it)
{
    it->visitFP1OUTPUTStatement(true,this,it);
}

void IRPARAMStatement::traverse(IRTraverser* it)
{
    bool visit = true;
...
void IRLocalEnvBinding::traverse(IRTraverser* it)
{
    it->visitLocalEnvBinding(true,this,it);
}

void IRConstantBinding::traverse(IRTraverser* it)
{
    it->visitConstantBinding(true,this,it);
}

void IRStateBinding::traverse(IRTraverser* it)
{
