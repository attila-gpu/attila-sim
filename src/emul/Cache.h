...
protected:
     ...
     *  @param line Reference to a variable where to store the cache line for the address.
     *  @param way Reference to a variable where to store the cache way for the address.
     *
     *  @return If the address was found in the cache tag file.
     *
     */

    bool search(u32bit address, u32bit &line, u32bit &way);
    ...
    u32bit tag(u32bit address);

    /**
     *
     *  Retrieves the address of the first byte of the specified line.
     *
     *  @param way The way of the cache line for which to get the memory address.
     *  @param line The line of the cache line for which to get the memory address.
     *
    ...
    u32bit line2address(u32bit way, u32bit line);
...
public:
    ...
    Cache(u32bit numWays, u32bit numLines, u32bit bytesLine,
     ...
     *
     *  @param address Address (32 bits) of the word to be read
     *  from the cache.
    ...
    bool read(u32bit address, u32bit &data);

    /**
     *
     *  Writes a 32 bit word to the cache.
     *
     *  @param address Address (32 bits) of the word to be written
     *  in the cache.
     ...
     */
     ...
     bool write(u32bit address, u32bit &data);
     ...
     *
     *  @param address Address (32 bits) for which a line
     *  is needed.
     *
    ...
    u32bit selectVictim(u32bit address);
    ...
    void replace(u32bit address, u32bit way, u8bit *data);
    ...
    void replace(u32bit address, u32bit way);
    ...
    void fill(u32bit address, u8bit *data);
    ...
    void invalidate(u32bit address);
