...
DECLARE_INTERFACE_(IDirect3DDevice9, IUnknown)
{
    ...
    STDMETHOD(DrawIndexedPrimitive)(THIS_ D3DPRIMITIVETYPE Type,INT BaseVertexIndex,UINT MinVertexIndex,UINT NumVertices,UINT startIndex,UINT primCount) PURE;
