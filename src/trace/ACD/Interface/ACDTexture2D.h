...
#ifndef ACD_TEXTURE2D
    #define ACD_TEXTURE2D
...
/**
 * This interface represents a 2D  texture
 *
 * @author Carlos González Rodríguez
 * @version 1.0
 * @date 28/03/2007
 */
class ACDTexture2D : public ACDTexture
{
public:
    ...
    virtual void copyData(acd_uint srcMipLevel, acd_uint dstMipLevel, ACDTexture2D* destTexture) = 0;
    ...
    virtual void updateData( acd_uint mipLevel, const acd_ubyte* srcTexelData, acd_bool preloadData = false) = 0;
    ...
    /**
     * Unmaps a mipmap subresource from a 2D texture
     *
